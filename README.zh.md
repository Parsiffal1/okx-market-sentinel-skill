...
- *在所有 OKX 可交易标的里，哪些名字现在真的值得盯？*
- *怎么把这些信息整理成另一位操作员或 agent 能几秒读懂的简报？*

**OKX 市场哨兵做的，就是把这层判断能力沉淀成一个可复用 skill。**
...
### 持仓优先
- `跑一轮 OKX 市场哨兵，先复查我的持仓，再告诉我还有什么值得关注。`
- `结合当前市场、宏观和加密原生信息，重新评估这些仓位。`

### 全市场扫描
- `扫一遍 OKX 可交易标的，排出现在最值得看的名字。`
- `给我一版简洁的 OKX 市场哨兵会话摘要。`
